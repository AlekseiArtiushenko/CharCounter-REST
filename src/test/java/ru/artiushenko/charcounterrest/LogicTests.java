...
class LogicTests {
    @Test
    void definingUniqueSymbols() {
        String uniqueSymbolsString = "sГ2";
        ...
        Assertions.assertEquals(1, testMap.get('2'), "Количество символа '2' должно быть 1");
    }
    ...
    void definingRepeatedSymbols() {
        ...
        Assertions.assertEquals(7, testMap.size(), "Размер результата должен быть равен длине строки с уникальными символами");
